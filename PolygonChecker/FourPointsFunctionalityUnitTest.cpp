...
// Declaring the C functions to be tested
...
namespace FourPointsFunctionalityUnitTest
{
    ...
    public:
        ...
        // Testing for invalid rectangle (not a rectangle)
        ...
        // Testing for perimeter calculation
        ...
        // Testing for rectangle with sides in reverse order
        ...
        // Testing for rectangle with sides of different lengths
        ...
        // Testing for points forming a parallelogram (not a rectangle)
        ...
        // Testing for degenerate rectangle (points on the same line)
        ...
        // Testing for points forming a line (not a rectangle)
        ...
        // Testing for points forming a rectangle with very large coordinates
        ...
        // Testing for points forming a rectangle with very small coordinates
        ...
        // Testing for not a rectangle (line) not equal to another shape
        ...
        // Testing for degenerate rectangle (points on the same line) not equal to another shape
        ...
        // Testing for rectangle with sides of different lengths not equal to another shape
