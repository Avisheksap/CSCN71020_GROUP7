...
namespace TriangleInsideAngleFunctionalityUnitTest
{
    ...
    public:
        ...
        TEST_METHOD(TestEquilateralTriangleAngles)
        {
            ...
            // Assert
            Assert::AreEqual(60.0, angle1 * (180.0 / M_PI));
            Assert::AreEqual(60.0, angle2 * (180.0 / M_PI));
            Assert::AreEqual(60.0, angle3 * (180.0 / M_PI));
        }
        ...
        TEST_METHOD(TestIsoscelesTriangleAngles)
        {
            ...
            // Assert
            Assert::AreEqual(53.1301, angle1 * (180.0 / M_PI), 0.0001);
            Assert::AreEqual(53.1301, angle2 * (180.0 / M_PI), 0.0001);
            Assert::AreEqual(73.7398, angle3 * (180.0 / M_PI), 0.0001);
        }
